...
4b | Link to `commit #1 from Github.com` |[commit #1 from Github.com](https://github.com/)
...
5a | 2nd Favorite emoji |✂️
5b | Link to `commit #2 from Github Desktop` |[commit #2 from Github.com](https://github.com/JacaryLightsey/learn-git-milestones)
